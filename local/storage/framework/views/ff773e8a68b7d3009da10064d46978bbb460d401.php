...
<option value="<?php echo e($ot); ?>" <?php if($data->opening_time == $ot): ?> selected <?php endif; ?>><?php echo e($ot); ?></option>
...
<option value="<?php echo e($ct); ?>" <?php if($data->closing_time == $ct): ?> selected <?php endif; ?>><?php echo e($ct); ?></option>
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/fda_jpn/local/resources/views/admin/user/form.blade.php */ ?>