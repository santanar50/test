...
<a href="<?php echo e(Asset('export')); ?>" class="btn m-b-15 ml-2 mr-2 btn-rounded btn-info">Export Excel</a>
<a href="<?php echo e(Asset('import')); ?>" class="btn m-b-15 ml-2 mr-2 btn-rounded btn-success">Upload Excel</a>
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/fda_ibh/local/resources/views/user/item/index.blade.php */ ?>