...
<tr>
<td width="17%"><?php if($row->store): ?> <?php echo e($row->store); ?> <?php else: ?> From Admin <?php endif; ?></td>
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/food_ims/local/resources/views/admin/delivery/index.blade.php */ ?>