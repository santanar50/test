...
<a href="<?php echo e(Asset(env('admin').'/order/edit/'.$row->id)); ?>">Edit Order</a><hr>
...
<a href="<?php echo e(Asset(env('admin').'/orderStatus?id='.$row->id.'&status=4')); ?>" onclick="return confirm('Are you sure?')">Give Order</a><hr>
...
<a href="<?php echo e(Asset(env('admin').'/order/print/'.$row->id)); ?>" target="_blank">Print Bill</a><hr>
...
<a href="<?php echo e(Asset(env('admin').'/order/print/'.$row->id)); ?>" target="_blank">Print Bill</a>


<?php endif; ?>
<?php /* /Applications/XAMPP/xamppfiles/htdocs/fda_ibh/local/resources/views/admin/order/action.blade.php */ ?>