...
<td width="20%"><?php echo e($row->mobile); ?></td>
<td width="20%">
...
<a href="<?php echo e(Asset($link.'/edit/'.$row->id)); ?>" class="btn m-b-15 ml-2 mr-2 btn-md  btn-rounded-circle btn-success" data-toggle="tooltip" data-placement="top" data-original-title="Edit This Entry"><i class="mdi mdi-border-color"></i></a>
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/new_admin/local/resources/views/admin/user/index.blade.php */ ?>