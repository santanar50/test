<?php $__env->startSection('title'); ?> Manage Sub Accounts <?php $__env->stopSection(); ?>
...
<tr>
<td width="20%"><?php echo e($row->username); ?></td>
<td width="20%"><?php echo e($row->shw_password); ?></td>
<td width="20%"><?php echo e($row->name); ?></td>
<td width="20%"><?php echo e($row->perm); ?></td>
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/fda_ibh/local/resources/views/admin/adminUser/index.blade.php */ ?>