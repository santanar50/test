...
<div class="row">
<div class="col-md-12" style="text-align: right;"><a href="<?php echo e(Asset('order/add')); ?>" class="btn m-b-15 ml-2 mr-2 btn-rounded btn-warning">Add New</a>&nbsp;&nbsp;&nbsp;</div>
...
<?php echo $__env->make('user.order.action', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/fda_ibh/local/resources/views/user/order/index.blade.php */ ?>