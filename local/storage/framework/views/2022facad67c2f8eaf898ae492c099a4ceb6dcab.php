...
function initMap() {
  ...
  autocomplete.addListener('place_changed', function() {
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAwl82PN5kAQUgVqmyFNTQmreW82aZQenE
&libraries=places&callback=initMap"
        async defer></script>
  
<?php /* /Applications/XAMPP/xamppfiles/htdocs/fds/local/resources/views/admin/user/google.blade.php */ ?>