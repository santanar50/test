<?php $__env->startSection('title'); ?> Manage Offers <?php $__env->stopSection(); ?>
...
<tr>
<td width="17%"><?php echo e($row->code); ?></td>
<td width="17%">
<?php if($row->type == 0): ?> <?php echo e($row->value); ?>% <?php else: ?> <?php echo e($row->value); ?> <?php endif; ?>

</td>
<td width="17%"><?php echo e(date('d-M-Y',strtotime($row->created_at))); ?></td>
<td width="17%">

<?php if($row->status == 0): ?>

<button type="button" class="btn btn-sm m-b-15 ml-2 mr-2 btn-success">Active</button>

<?php else: ?>

<button type="button" class="btn btn-sm m-b-15 ml-2 mr-2 btn-danger">Disabled</button>
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/food_ims/local/resources/views/user/offer/index.blade.php */ ?>